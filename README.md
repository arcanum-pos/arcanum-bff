...
`arcanum.kaboutersoft.be`: handles login against Auth0 (Google Workspace
...
```
Browser
  └─ arcanum.kaboutersoft.be/*  → questo-bff
...
1. Visit `https://arcanum.kaboutersoft.be/` → redirected to `/login` →
